  ...
  if (data && city) {
    return (
      <div className="weatherCard">
        ...
        <h3>
          <span>
            {Math.round(((data.main.temp - 273.15) * 9) / 5 + 32)} Fahrenheit,{" "}
            {Math.round(data.main.temp - 273.15)} Celsius{" "}
          </span>
        </h3>
        <h3>
          <span>
            ...
            Fahrenheit, {Math.round(data.main.feels_like - 273.15)} Celsius{" "}
          </span>
        </h3>
        <h3>
        ...
        <h3>
          <span>
            Sunrise:{" "}
            {convertUnixTimestampToCityTime(data.sys.sunrise, data.timezone)}
          </span>
        </h3>
        <h3>
          <span>
            Sunset:{" "}
            {convertUnixTimestampToCityTime(data.sys.sunset, data.timezone)}{" "}
          </span>
        </h3>
      </div>
    );
